...
public:
	...
	void punchattack()
	{
		cout << name << " Used Firepunch from firepokeman! " << damage << endl;
	}
	void kickattack()
	{
		cout << name << " Used stomp1" << " hit for " << damage << endl;
	}
	void specialatk()
	{
		cout << name << " Used flamethrower! " << " hit for " << damage << endl;
	}
	void displaystats()
	{
...
public:
	void punchattack()
	{
		cout << name << " drop! " << "hit for " << damage << endl;
	}
	void kickattack()
	{
		cout << name << " Watergun " << " hit for " << damage << endl;
	}
	void specialatk()
	{
		cout << name << " water gun " << " hit for " << damage << endl;
	}
	void displaystats()
	{
		cout << name << " Id: " << id << endl;
...
public:
	...
	void specialatk()
	{
		cout << name << " beam " << " hits " << damage << endl;
	}
	void displaystats()
	{
		cout << name << " Id: " << id << endl;
